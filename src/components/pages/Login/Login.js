...
const Login = () => {
    ...
    return (
        <>
            ...
            <div className='text-center justify-center gap-32 flex '>
                <div className='text-bold font-bold'>
                    <p className='text-xl' >Demo Admin</p>
                    <h2>Email: <span>xyz@gmail.com</span> </h2>
                    <h2>Password: <span>123456</span> </h2>
                </div>
                <div className='text-bold font-bold'>
                    <p className='text-xl' >Demo User</p>
                    <h2>Email: <span>xyz@demo.com</span> </h2>
                    <h2>Password: <span>123456</span> </h2>
                </div>
            </div>
        </>
